...
public class ParkGenerator : MonoBehaviour {
    ...
    void InitMesh(GameObject g, Vector3 pos, float scale, Quaternion rotation) {
        ...
        Collider[] miscCollisions = Physics.OverlapSphere(obj.transform.position, miscRadius, 1 << 9);
        Collider[] treeToMiscCollisions = Physics.OverlapSphere(obj.transform.position, treeRadius, 1 << 9);
